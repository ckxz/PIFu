### ======================================== Code from https://github.com/shunsukesaito/PIFu ======================================== ###
...
import numpy as np
import cv2
from render_camera import Camera
from render_mesh import load_obj_mesh, compute_tangent, compute_normal, load_obj_mesh_mtl
...
if __name__ == '__main__':
	env_sh = '/Users/ckxz/Desktop/@City/363, FP/AISculpture/PIFuHD/DS-Related/renderer/env_sh.npy'
	shs = np.load(env_sh)

	parser = argparse.ArgumentParser()
	parser.add_argument('-i', '--input', type=str, default='/Users/ckxz/Desktop/rp_dennis_posed_004_OBJ')
	parser.add_argument('-o', '--out_dir', type=str, default='/Users/ckxz/Desktop/output')
	...
	from gl.init_gl import initialize_GL_context

	initialize_GL_context(width=args.size, height=args.size, egl=args.egl)

	from gl.prt_render import PRTRender
